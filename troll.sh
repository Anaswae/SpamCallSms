...
troll(){
    ...
    clear
    toilet -f standard --gay "MR.HACKDAY"
date | lolcat
    sleep 08.00
...
mulai (){
    echo "Gunakan Troll Project Lagi Apa Tidak?"
    echo "y/n?"
    echo
    read lagi
    if [ $lagi = "y" ]; then
...
spam(){
    ...
    if [ $pilih = "1" ]; then
        ...
        echo "Terimakasih sudah menggunakan Troll project spammer"
        close
    else
        clear
        echo "Kesalahan"
...
clear
echo "Tunggu.."
echo "Baca BISMILLAH dulu gaes.."
echo "Jangan disalah gunakan.."

load
clear
troll
echo Selamat datang teman setia HACKDAY, Siapa nick kamu bro ? #tulisan keluar
read nick #membaca yang ditulis
clear
troll
echo Selamat datang di troll kami$nick ":)"
echo
